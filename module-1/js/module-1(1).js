...
/*
Напиши скрипт проверки пользователя при доступе к контенту
...
/*
Тернарный оператор! используется только если два варианта
Если вариантов несколько, т.е. больше двух, то 
...
'Общая стоимость заказа [число] кредитов. Проверяем кол-во доступных
средств на счету'
...
let message;
 ...
 if(payment < balance) {
   message = `всё хорошо, снимаем деньги... Спасибо за покупку!на счету осталось ${balance - payment} кредитов `
